...
CREATE TABLE IF NOT EXISTS TB_USUARIO (
    ...
    ID_ASSINATURA_FK INT NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS TB_PEDIDO_COMPRA (
    ...
    QTD_PEDIDO DECIMAL(5,2) NOT NULL,
...
CREATE TABLE IF NOT EXISTS TB_ITEM_COMPRA (
    ...
    LOTE_COMRPA VARCHAR(25), -- Codigo do lote
...
CREATE TABLE IF NOT EXISTS TB_ESTOQUE_PRODUTO(
    ...
    ID_PRODUTO_FK INT,
    ID_USUARIO_FK INT,
    QTD_TOTAL_ESTOQUE_ESTOQUE DECIMAL(10,2) NOT NULL DEFAULT 0,
    VALOR_GASTO_TOTAL_ESTOQUE DECIMAL(10,2) NOT NULL DEFAULT 0,
    VALOR_POTENCIAL_VENDA_ESTOQUE DECIMAL(10,2) NOT NULL,
...
CREATE TABLE IF NOT EXISTS TB_ITENS_LUCRO (
    ...
    FOREIGN KEY (ID_COMPRA_FK) REFERENCES TB_PEDIDO_COMPRA(ID_COMPRA)
) ENGINE=InnoDB;
